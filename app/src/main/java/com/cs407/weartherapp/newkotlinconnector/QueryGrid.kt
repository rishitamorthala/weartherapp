package com.cs407.weartherapp.com.cs407.weartherapp.newkotlinconnector

import com.example.newkotlinconnector.BuildYourUrl
import com.example.newkotlinconnector.QueryApi
...
class QueryGrid {
    ...
    fun dataToDataFrame(queryResponse: Parameters): DataFrame<Coordinate> {
